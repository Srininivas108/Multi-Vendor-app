  ...
  return (
    <div className='header-row'>
        <div className="header-top">
            <span><FontAwesomeIcon icon={faPhone}/>+917569394523</span>
            <span><FontAwesomeIcon icon={faEnvelope}/>srinivas584@gmail.com</span>
        </div>
        <div className="header-menu">
            <div className="header-logo">
                <Link to="/"><h2 className="header-logo-title">Srinivas</h2></Link>
            </div>
