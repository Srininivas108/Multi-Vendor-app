    ...
    <div className='passwords'>
      <form onSubmit={handlerAddProduct}>
        ...
        <div className="form-group form-image product">
            ...
            <input required type="text" id='imageProduct' onChange={(e) => setImageProduct(e.target.value)} value={imageProduct} />
        </div>
        <div className="form-btn">
            <button type='submit'><FontAwesomeIcon icon={faPlusCircle} />{imageProduct ? "Saving..." : "Save Product"}</button>
        </div>
      </form>
    </div>
  )
